# Profiling the Morphogenesis code

If you have Cuda-toolkit installed, enter "nsight-sys" at the commandline to open "Nvidia Nsight Systems".
    
See [https://developer.nvidia.com/nsight-systems](https://developer.nvidia.com/nsight-systems) , 
...
[https://docs.nvidia.com/nsight-systems/InstallationGuide/index.html#linux-requirements](https://docs.nvidia.com/nsight-systems/InstallationGuide/index.html#linux-requirements)

For a an introduction to how to use Nsight Systems, see "Blue Waters Webinar: Introduction to NVIDIA Nsight Systems"   [https://www.youtube.com/watch?v=WA8C48FJi3c](https://www.youtube.com/watch?v=WA8C48FJi3c) 
...
## NB memory usage
    ...
    These arrays are use to produce the dense lists of particles for each kernel, for efficient computation.
...
- **The sorting bins are cubes of side-length = smoothing-radius of the particles.**
